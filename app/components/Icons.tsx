...
export function IconBlob() {
  return (
    <svg
      ...
      fill='#60a5fa'
      className='-z-10 col-start-1 row-start-1 -ml-28 hidden h-[300px] w-[300px] blur-md md:block md:h-[400px] md:w-[400px]'
    >
...
export function IconBlobTwo() {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      viewBox='0 0 2000 1800'
      fill='#60a5fa'
      className='-z-10 col-start-1 row-start-1 h-[300px] w-[300px] rotate-180 blur-md md:h-[400px] md:w-[400px]'
    >
      <path d='M1386.57 181.4c160.9 73.74 328.5 149.72 424.59 281.57 96.09 129.61 118.44 315.09 98.33 487.16-20.11 172.07-84.92 332.97-187.71 446.94-105.03 116.2-250.29 185.48-391.07 243.58-138.55 60.34-272.63 109.5-393.31 91.62-122.91-17.88-234.64-102.8-377.66-160.9-143.02-58.1-317.33-87.15-406.71-183.24-89.39-96.09-96.09-261.46 2.23-368.72 98.33-109.5 301.68-160.9 384.37-270.4 82.68-111.73 42.46-283.81 84.92-422.36C669.24 188.1 798.86 80.83 937.41 60.72c140.79-20.11 290.51 49.16 449.17 120.67Z'></path>
    </svg>
  );
...
export function Wave() {
  return (
    <svg
      id='visual'
      viewBox='0 483 900 118'
      xmlns='http://www.w3.org/2000/svg'
      version='1.1'
      className='w-full'
    >
      <path
        d='M0 523L12.5 516.3C25 509.7 50 496.3 75 489.8C100 483.3 125 483.7 150 483.5C175 483.3 200 482.7 225 488C250 493.3 275 504.7 300 512.2C325 519.7 350 523.3 375 519.7C400 516 425 505 450 506.5C475 508 500 522 525 528.8C550 535.7 575 535.3 600 533.2C625 531 650 527 675 520.8C700 514.7 725 506.3 750 504.5C775 502.7 800 507.3 825 508.3C850 509.3 875 506.7 887.5 505.3L900 504L900 601L887.5 601C875 601 850 601 825 601C800 601 775 601 750 601C725 601 700 601 675 601C650 601 625 601 600 601C575 601 550 601 525 601C500 601 475 601 450 601C425 601 400 601 375 601C350 601 325 601 300 601C275 601 250 601 225 601C200 601 175 601 150 601C125 601 100 601 75 601C50 601 25 601 12.5 601L0 601Z'
        fill='#EBEBEB'
        stroke-linecap='round'
